...
func (t *SimpleChaincode) Query(stub *shim.ChaincodeStub, function string, args []string) ([]byte, error) {
	...
	if function == "get_user" {
        ...
        return t.GetResource(stub, args)
    }
...
func (t *SimpleChaincode) AddResource(stub *shim.ChaincodeStub, args []string) ([]byte, error) {
...
func (t *SimpleChaincode) GetResource(stub *shim.ChaincodeStub, args []string) ([]byte, error) {
